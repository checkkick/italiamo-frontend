<template>
	...
	<main class="main flex-column">
		<section class="about-payment card-shadow">
			<p>
				Оплатить занятия итальянским языком вы можете прямо на этой странице банковской картой
				любого банка в любой валюте. Платеж будет списан в рублях РФ.
			</p>
			<p>
				Данные вашей карты не вводятся и не хранятся на нашем сайте. После нажатия кнопки
				«оплатить» вы будете перенаправлены на платежную страницу «Сбербанк» для ввода данных
				карты и проведения оплаты. Все платежи осуществляются по защищенной технологии HTTPS с
				применением механизма двухфакторной аутентификации 3D secure.
			</p>
			<p>
			...
			<p>
				...
				<router-link class="link" @click="scrollToTop" to="/oferta">Договора-оферты</router-link
				>.
			</p>
			<p>
				В случае неисполнения или ненадлежащего оказания услуг, а также в случае, если договор
				расторгается по вашему желанию, вы можете предоставить нам мотивированный отказ от
				услуг. В этом случае мы возвращаем денежные средства в размере, равном сумме не
				исполненных обязательств, за удержанием суммы комиссий перевода денежных средств. Срок
				возврата денежных средств составляет до 30 календарных дней.
			</p>
		</section>
    ...
    function(order) { showFailurefulPurchase(order) })"
		...
		<section class="about-garanty flex-row">
			...
			<div class="garanty card-shadow">
				...
				<h4>Мы на связи</h4>
				<p>
					Мы ответим на любые вопросы, касающиеся оплаты, проведения занятий или расписания
					уроков. Свяжитесь с нами по тел. <a href="tel:+79300309922">+7(930)030-99-22</a> или
