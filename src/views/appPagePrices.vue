    ...
    <main class="flex-column">
        <table class="table">
            ...
            <tr class="table-row-2">
                <td class="table-row-item" aria-label="Типы занятий">Занятие с преподавателем - носителем языка</td>
            ...
            <div class="flex-row">
                <div class="price-card">
                    <div class="price-card-title">
                        <h3>Международный экзамен А2 (CELI, CILS, PLIDA)</h3>
                        <h3>14 700 руб.</h3>
                    </div>
                    <div class="price-card-text">
                        ...
                        <button @click="routerPush('/payment')" class="btn">Подробнее</button>
                    </div>
                </div>
                <div class="price-card">
                    <div class="price-card-title">
                        <h3>Международный экзамен В1, В2, С1 (CELI, CILS, PLIDA)</h3>
                        <h3>19 700 руб.</h3>
                    </div>
                    <div class="price-card-text">
                        <h4>Курс 24 часа</h4>
...
<script>
    ...
    export default {
        ...
        setup() {
            useMeta({
                title: 'Стоймость обучения',
                description: 'В нашей школе одни из самых низких цен среди школ Итальянского языка! Цены на занятия с носителями языка и не только. Цены на индивидуальные занятия и в группе, а так же на подготовку к экзаменам.',
                htmlAttrs: {lang: 'ru'},
